...
object Acu {
    ...
    fun getRenderer(id: Int, acu_click: (Int) -> Unit, kategori_click: (String, String) -> Unit): Renderer {
        val offlen = offlens[id - 1]
        return Renderer(offlen shr 24, offlen and 0xffffff, acu_click, kategori_click)
    }
}
