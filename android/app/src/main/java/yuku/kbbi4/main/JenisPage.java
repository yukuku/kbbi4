...
public class JenisPage extends ContentPage {
	...
	public void onViewCreated(final View view, @Nullable final Bundle savedInstanceState) {
		...
		lsAcus.setAdapter(kategoriAdapter = new KategoriAdapter());
		kategoriAdapter.setData(KategoriRepo.INSTANCE.listKategoris(jenis));
	}
	...
	class KategoriAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
